...
mixin _$Media {
  ...
  FileTypeOption get type => throw _privateConstructorUsedError;
...
abstract class $MediaCopyWith<$Res> {
  ...
  @useResult
  $Res call({String url, FileTypeOption type});
}
...
class _$_Media implements _Media {
  const _$_Media({required this.url, required this.type});
...
abstract class _Media implements Media {
  const factory _Media(
      ...
      required final FileTypeOption type}) = _$_Media;

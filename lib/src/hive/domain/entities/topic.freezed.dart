...
class _$_Topic implements _Topic {
  ...
  @override
  String toString() {
    return 'Topic(id: $id, name: $name, description: $description, createdBy: $createdBy, createdAt: $createdAt)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, description, createdBy, createdAt);
